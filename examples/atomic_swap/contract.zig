...
//! Invoke: `stellar contract invoke --id atomic_swap --source user_a --network testnet /
//!          -- swap --a user_a --b user_b --token_a <stellar-asset-contract-id> --token_b <stellar-asset-contract-id> /
