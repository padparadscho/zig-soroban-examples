...
//! Deploy: `stellar contract deploy --wasm zig-out/bin/errors.wasm --alias errors --source deployer`
//! Invoke: `stellar contract invoke --id errors --source user --network testnet -- increment`
