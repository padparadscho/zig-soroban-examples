...
//! Deploy: `stellar contract deploy --wasm zig-out/bin/logging.wasm --source <account-private-key>`
//! Invoke: `stellar contract invoke --id <contract-id> --source <account-private-key> --network testnet -- hello --value world`
